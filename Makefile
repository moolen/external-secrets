...
docker.build.providers: docker.build.provider.kubernetes docker.build.provider.aws ## Build all provider images
...
docker.push.providers: docker.push.provider.kubernetes docker.push.provider.aws ## Push all provider images
