...
func (c *grpcProviderClient) GetSecret(ctx context.Context, ref esv1.ExternalSecretDataRemoteRef, providerConfig []byte) ([]byte, error) {
	c.log.V(1).Info("getting secret via gRPC",
		"key", ref.Key,
		"version", ref.Version,
		"property", ref.Property,
		"connectionState", c.conn.GetState().String(),
		"configSize", len(providerConfig))
	...
	// Make gRPC call with provider config
...
func (c *grpcProviderClient) Validate(ctx context.Context, providerConfig []byte) error {
...
func (c *grpcProviderClient) GetAllSecrets(ctx context.Context, find esv1.ExternalSecretFind, providerConfig []byte) (map[string][]byte, error) {
...
func (c *grpcProviderClient) PushSecret(ctx context.Context, secretData map[string][]byte, pushSecretData *pb.PushSecretData, providerConfig []byte) error {
...
func (c *grpcProviderClient) DeleteSecret(ctx context.Context, remoteRef *pb.PushSecretRemoteRef, providerConfig []byte) error {
...
func (c *grpcProviderClient) SecretExists(ctx context.Context, remoteRef *pb.PushSecretRemoteRef, providerConfig []byte) (bool, error) {
...
func (c *grpcProviderClient) Capabilities(ctx context.Context, providerConfig []byte) (pb.SecretStoreCapabilities, error) {
