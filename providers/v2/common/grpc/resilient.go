...
func (rc *ResilientClient) PushSecret(ctx context.Context, secretData map[string][]byte, pushSecretData *pb.PushSecretData, providerConfig []byte) error {
	return rc.executeWithResilience(ctx, func(client v2.Provider) error {
		return client.PushSecret(ctx, secretData, pushSecretData, providerConfig)
	})
}

// DeleteSecret deletes a secret with retry logic and circuit breaking.
func (rc *ResilientClient) DeleteSecret(ctx context.Context, remoteRef *pb.PushSecretRemoteRef, providerConfig []byte) error {
	return rc.executeWithResilience(ctx, func(client v2.Provider) error {
		return client.DeleteSecret(ctx, remoteRef, providerConfig)
	})
}

// SecretExists checks if a secret exists with retry logic and circuit breaking.
func (rc *ResilientClient) SecretExists(ctx context.Context, remoteRef *pb.PushSecretRemoteRef, providerConfig []byte) (bool, error) {
	var result bool

	err := rc.executeWithResilience(ctx, func(client v2.Provider) error {
		exists, err := client.SecretExists(ctx, remoteRef, providerConfig)
		if err != nil {
			return err
		}
		result = exists
...
func (rc *ResilientClient) GetSecret(ctx context.Context, ref esv1.ExternalSecretDataRemoteRef, providerConfig []byte) ([]byte, error) {
	var result []byte

	err := rc.executeWithResilience(ctx, func(client v2.Provider) error {
		secretData, err := client.GetSecret(ctx, ref, providerConfig)
		if err != nil {
			return err
		}
		result = secretData
...
func (rc *ResilientClient) GetAllSecrets(ctx context.Context, find esv1.ExternalSecretFind, providerConfig []byte) (map[string][]byte, error) {
	var result map[string][]byte

	err := rc.executeWithResilience(ctx, func(client v2.Provider) error {
		secrets, err := client.GetAllSecrets(ctx, find, providerConfig)
		if err != nil {
			return err
		}
		result = secrets
...
func (rc *ResilientClient) Validate(ctx context.Context, providerConfig []byte) error {
	return rc.executeWithResilience(ctx, func(client v2.Provider) error {
		return client.Validate(ctx, providerConfig)
	})
}

// Capabilities retrieves the provider's capabilities with retry logic.
func (rc *ResilientClient) Capabilities(ctx context.Context, providerConfig []byte) (pb.SecretStoreCapabilities, error) {
	var result pb.SecretStoreCapabilities

	err := rc.executeWithResilience(ctx, func(client v2.Provider) error {
		caps, err := client.Capabilities(ctx, providerConfig)
		if err != nil {
			return err
		}
		result = caps
